...
- [typos.toml](../typos.toml) configures the
  ...
  en-GB-oxendict (Oxford) spelling over the repository. `make spelling`
  regenerates it from the live shared dictionary and the
  [typos.local.toml](../typos.local.toml) overlay; never edit generated entries
  by hand.
