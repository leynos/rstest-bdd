...
- `gpui::run_test(num_iterations, explicit_seeds, max_retries, test_fn, on_fail_fn)` —
  vendored shim signature unchanged.
- `rstest_bdd_harness::ScenarioMetadata::{feature_path, scenario_name, scenario_line}` —
  getter accessors unchanged.
